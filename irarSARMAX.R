  ...
  
{
  ...
  score <- function(z) 
  {
    ...
    score<-c(Ubeta0,Ubeta,Uphi,UPHI,UTHETA,Ulambda0,Ulambda1)
    return(score)
  }#fim score
  
  y1<-y[(m+1):n] 
  
  reg <- c(0,rep(0,p1+P1+Q1+k), length(y1[which(y1==0)])/length(y1),0) 
  z=c()
  ...
  THETA <-coef[(k+p1+P1+2):(k+p1+P1+Q1+1)] #MA
  ...
  Fisher.inf<-function(y1,muhat,lambdahat)
  {
    ...
    K <- rbind(
      cbind(KB0B0,KB0B,KB0p,KB0P,KB0Q,KB0lambda0,KB0lambda1),
      cbind(KBB0,KBB,KBp,KBP,KBQ,KBlambda0,KBlambda1),
      cbind(KpB0,KpB,Kpp,KpP,KpQ,Kplambda0,Kplambda1),
      cbind(KPB0,KPB,KPp,KPP,KPQ,KPlambda0,KPlambda1),
      cbind(KQB0,KQB,KQp,KQP,KQQ,KQlambda0,KQlambda1),
      cbind(Klambda0B0,Klambda0B,Klambda0p,Klambda0P,Klambda0Q,Klambda0lambda0,Klambda0lambda1),
      cbind(Klambda1B0,Klambda1B,Klambda1p,Klambda1P,Klambda1Q,Klambda1lambda0,Klambda1lambda1)
    )
    return(K)
  }
  ...
  first_col<-c("intercept",1:k,ar, AR, MA, "lambda0 estimator", "lambda1 estimator")
