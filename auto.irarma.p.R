...
auto.irarma<-function(y,steps=10,exvar=matrix(NA, nrow=1, ncol=1, byrow=F),max.order=1,graph=F,print=F,check=F,type="Box-Jenkins",sort="mbic",S=12,resid=4,seasonal=T,bloco=1,nblocos=15){
  library(tictoc)
  
  nome1<-paste("auto.irarma_",bloco,".txt", sep="")
